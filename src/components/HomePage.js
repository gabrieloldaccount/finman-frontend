...
const HomePage = ({props}) => {
    ...
    return(
        <container className='homebuttons'>
            <HomePageButton text1={'create'} text2={'new invoice'} onClick={goToInvoice}/>
            <HomePageButton text1={'product'} text2={'catalog'} onClick={goToCatalog} />
            <HomePageButton text1={'all'} text2={'invoices'} onClick={goToAllInvoices}/>
